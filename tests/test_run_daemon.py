...
def test_run_daemon_handles_calledprocesserror_once(settings):
    ...
    with patch("wb.cloud_agent.main.logging.exception") as mock_log_exception:
        with patch("wb.cloud_agent.main.make_event_request") as mock_request:
            ...
            def stop_after_error_status(*args, **kwargs):
