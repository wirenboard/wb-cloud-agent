...
- `test_metrics_collector.py` renders the shipped collector template and checks MQTT CONNACK handling,
  connection retries, reconnect subscription recovery, interruptible startup/shutdown, and the systemd exit
  policy.
