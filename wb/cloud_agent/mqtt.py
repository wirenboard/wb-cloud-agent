...
class MQTTCloudAgent:
    ...
    def publish_vdev(self, activation_link, cloud_base_url):
        ...
        self.client.publish(f"{self.mqtt_prefix}/controls/status", "connecting", retain=True, qos=2)
        self.client.publish(
            f"{self.mqtt_prefix}/controls/activation_link", activation_link, retain=True, qos=2
        )
        self.client.publish(f"{self.mqtt_prefix}/controls/cloud_base_url", cloud_base_url, retain=True, qos=2)
